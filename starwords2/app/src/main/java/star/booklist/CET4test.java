...
import star.test.CET4wordstest;
...
public class CET4test extends ListActivity {	
    ...
    SimpleAdapter adapter = new SimpleAdapter(this,mData,android.R.layout.simple_list_item_1,  
        ...
        mListView.setOnItemClickListener(new OnItemClickListener(){   
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,   
				...
				Intent intent=new Intent(CET4test.this,CET4wordstest.class);	//Intent����
				Bundle bundle=new Bundle(); 	    
	     	    bundle.putInt("wordid", arg2*30+1);
