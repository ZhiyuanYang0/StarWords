...
import star.view.WordsBookViewuser1;
...
public class USER1 extends ListActivity {	

	private final static String TABLE_NAME="WordsBookuser1list";
    ...
    SimpleAdapter adapter = new SimpleAdapter(this,mData,android.R.layout.simple_list_item_1,  
        ...
        mListView.setOnItemClickListener(new OnItemClickListener(){   
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,   
				...
				Intent intent=new Intent(USER1.this,WordsBookViewuser1.class);	//Intent����
